    ...
    >
      ...
      >
        ...
        <Box sx={{ px: 1, textAlign: "center" }}>
          <Box>
            <Divider />
            <Box sx={{ marginY: 4 }}>Headphones and Headsets</Box>
            <Divider />
            <Box sx={{ marginY: 4 }}>Microphones</Box>
            <Divider />
            <Box sx={{ marginY: 4 }}>Conference Technology</Box>
            <Divider />
            <Box sx={{ marginY: 4 }}>Company </Box>
            <Divider />
            <Box sx={{ marginY: 4 }}>Services and support</Box>
            <Divider />
            ...
            <Divider />
            {
              ...
              >
                <Typography
                  sx={{ textTransform: "uppercase", paddingLeft: "1em" }}
                >
                  Follow Us :{" "}
                </Typography>
                <Instagram
